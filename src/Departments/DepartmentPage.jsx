...
// --- 🧱 Modal Component: CreateHeadModal (REUSABLE) ---
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const payload = {
                ...
                email: email,
                mobile: mobile,
                // Pass the departmentName (from props) to the API
...
// --- 💻 Reusable Component: DepartmentPage ---
    ...
    const fetchDepartmentHeads = async () => {
        ...
        try {
            ...
            if (data.head && Array.isArray(data.head)) {
                // FILTERING: Match heads where DepartmentName equals the prop value
                const fetchedHeads = data.head
                    .filter(head => head.DepartmentName === departmentName)
                    .map(head => ({
                        id: head._id,
                ...
                <div className="bg-white shadow-xl rounded-xl overflow-hidden">
                    <div className="p-5 border-b flex justify-between items-center">
                        <h2 className="text-xl font-semibold text-gray-800">
                            {departmentName} In-charge List ({heads.length})
                        </h2>
                        <button 
                                    ...
                                    {heads.length > 0 ? (
                                        ...
                                        <tr>
                                            <td colSpan="6" className="px-6 py-8 text-center text-gray-500">
                                                No Department Head found for {departmentName}. Click 'Create Head' to add one.
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
